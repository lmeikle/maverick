// stylelint.config.js (taken from https://medium.com/trabe/a-comprehensive-guide-to-using-bem-with-react-14d00c199e0d)
...
module.exports = {
  ...
  ignoreFiles: ['src/reset.css', 'src/index.css'],
  rules: {
